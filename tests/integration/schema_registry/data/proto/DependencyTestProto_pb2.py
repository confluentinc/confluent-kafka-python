...
from tests.integration.schema_registry.data.proto import (
    NestedTestProto_pb2 as tests_dot_integration_dot_schema__registry_dot_data_dot_proto_dot_NestedTestProto__pb2,
)
from tests.integration.schema_registry.data.proto import (
    PublicTestProto_pb2 as tests_dot_integration_dot_schema__registry_dot_data_dot_proto_dot_PublicTestProto__pb2,
)

try:
    tests_dot_integration_dot_schema__registry_dot_data_dot_proto_dot_TestProto__pb2 = (
        tests_dot_integration_dot_schema__registry_dot_data_dot_proto_dot_PublicTestProto__pb2.tests_dot_integration_dot_schema__registry_dot_data_dot_proto_dot_TestProto__pb2
    )
except AttributeError:
    tests_dot_integration_dot_schema__registry_dot_data_dot_proto_dot_TestProto__pb2 = (
        tests_dot_integration_dot_schema__registry_dot_data_dot_proto_dot_PublicTestProto__pb2.tests.integration.schema_registry.data.proto.TestProto_pb2
    )
...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'tests.integration.schema_registry.data.proto.DependencyTestProto_pb2', globals()
)
