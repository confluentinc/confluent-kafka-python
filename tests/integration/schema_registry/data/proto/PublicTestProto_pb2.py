...
from tests.integration.schema_registry.data.proto import (
    TestProto_pb2 as tests_dot_integration_dot_schema__registry_dot_data_dot_proto_dot_TestProto__pb2,
)
...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'tests.integration.schema_registry.data.proto.PublicTestProto_pb2', globals()
)
