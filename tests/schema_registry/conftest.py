...
if FREE_THREADED_BUILD:
    collect_ignore = [
        ...
        "test_cel_field_value_types.py",
        "test_cel_message_transform.py",
        "test_cel_null_avro_field.py",
        ...
        "_async/test_cel_avro_message_transform.py",
        ...
        "_sync/test_cel_avro_message_transform.py",
