...
def test_avro_payload_encryption():
    ...
    client.register_schema(_SUBJECT, Schema(json.dumps(schema), "AVRO", [], None, RuleSet(None, None, [rule])))
...
def test_avro_encryption_cel():
    ...
    client.register_schema(_SUBJECT, Schema(json.dumps(schema), "AVRO", [], None, RuleSet(None, [rule1, rule2])))
...
def test_avro_encryption_references():
    ...
    client.register_schema(_SUBJECT, Schema(json.dumps(schema), "AVRO", refs, None, RuleSet(None, [rule])))
...
def test_avro_serialize_strict_extra_fields_rejected():
    """
...
def test_avro_serialize_strict_missing_field_with_default():
    """
...
def test_avro_serialize_strict_allow_default_missing_field_with_default():
    """
...
def test_avro_serialize_strict_allow_default_extra_fields_rejected():
    """
...
def test_avro_serialize_strict_allow_default_union_with_default():
    """
...
def test_avro_serialize_strict_nested_record():
    """
...
def test_avro_serialize_deserialize_strict():
    """
...
def test_associated_name_strategy_with_association():
    ...
    client.delete_associations(resource_id="mock-resource-id-1", cascade_lifecycle=True)
...
def test_associated_name_strategy_with_key_association():
    ...
    client.delete_associations(resource_id="mock-resource-id-2", cascade_lifecycle=True)
...
def test_associated_name_strategy_fallback_to_record():
    ...
    registered_schema = client.get_latest_version("MyRecord")
    assert registered_schema is not None
...
def test_associated_name_strategy_fallback_to_topic_record():
    ...
    registered_schema = client.get_latest_version(_TOPIC + "-MyRecord")
    assert registered_schema is not None
...
def test_associated_name_strategy_with_kafka_cluster_id():
    ...
    registered_schema = client.get_latest_version("cluster-specific-subject")
    assert registered_schema is not None

    client.delete_associations(resource_id="mock-resource-id-4", cascade_lifecycle=True)
...
def test_associated_name_strategy_caching():
    ...
    client.delete_associations(resource_id="mock-resource-id-5", cascade_lifecycle=True)
