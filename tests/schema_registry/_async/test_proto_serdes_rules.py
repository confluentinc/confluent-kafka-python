...
#
"""
Tests for protobuf serdes that depend on the rules extra (tink/celpy) and are
...
from confluent_kafka.schema_registry import Metadata, MetadataProperties, Schema
