...
class TestCallbackManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.manager = CallbackManager(self.loop, initial_pool_size=10)
    ...
    def test_handle_sync_callback(self):
        ...
        # Call the manager
        self.manager.handle_user_callback(sync_callback, None, "test_msg")
    ...
    def test_handle_async_callback(self):
        ...
        with patch.object(self.loop, 'call_soon_threadsafe') as mock_call:
            self.manager.handle_user_callback(async_callback, None, "test_msg")
    ...
    def test_handle_none_callback(self):
        ...
        self.manager.handle_user_callback(None, None, "test_msg")
        
        # Should handle gracefully
        self.manager.handle_user_callback(None, Exception("test"), "test_msg")
    ...
    def test_sync_callback_exception_handling(self):
        ...
        try:
            self.manager.handle_user_callback(failing_callback, None, "test_msg")
        except Exception as e:
            self.fail(f"CallbackManager should handle callback exceptions: {e}")
    ...
    def test_event_loop_closed_handling(self):
        ...
        with patch.object(self.loop, 'call_soon_threadsafe', side_effect=RuntimeError("Event loop is closed")):
            ...
            try:
                ...
                self.fail(f"CallbackManager should handle closed event loop gracefully: {e}")
