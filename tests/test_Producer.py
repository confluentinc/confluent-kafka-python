...
def test_set_partitioner_cb():
    ...
    """
    p = Producer({'bootstrap.servers':'127.0.0.1:9092', "socket.timeout.ms": 10, "error_cb": error_cb})
    ...
    try:
        ...
        p.produce('mytopic2', "This is the message payload", "key", partitioner_cb=partitioner_cb)
