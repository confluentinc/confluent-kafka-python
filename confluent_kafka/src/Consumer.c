...
PyTypeObject ConsumerType = {
	...
	Py_TPFLAGS_HAVE_GC, /*tp_flags*/
        ...
        "including properties and callback functions). Additional information: "
        "https://docs.confluent.io/current/clients/confluent-kafka-python/#configuration"
        "\n\n"
        ":param dict config: Configuration properties. At a minimum ``group.id`` "
        "**must** be set, ``bootstrap.servers`` **should** be set."
        "\n\n"
        "\n"
        "\n", /*tp_doc*/
