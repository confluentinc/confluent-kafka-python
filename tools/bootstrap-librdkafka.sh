...
./configure --repo-url=https://github.com/edenhill/librdkafka/tree/master/mklove --update-modules --enable-static --install-deps --source-deps-only $EXTRA_OPTS --prefix="$INSTALLDIR"
