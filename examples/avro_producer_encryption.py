...
# A simple example demonstrating use of AvroSerializerBuilder with field-level
# encryption, driving a SerializingProducer.
#
# Unlike avro_producer.py, the Schema Registry client is built here rather than
# by the builder, because the encryption rule has to be registered with the
# subject before the producer starts; set_schema_registry_client() hands that
# existing client to the builder.
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="AvroSerializerBuilder encryption example")
