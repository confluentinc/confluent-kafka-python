...
class AdminClient (_AdminClientImpl):
    ...
    def list_consumer_groups(self, *args, **kwargs):
        if "states" in kwargs:
        ...
        return super(AdminClient, self).list_consumer_groups(*args, **kwargs)
    ...
    # Make input and output like Java
    ...
    # Change to reflect delete consumer groups response instead of alter consumer group offsets response
