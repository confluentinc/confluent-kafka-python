...
function install_client {
    sudo apt update && sudo apt install -y sudo python3-pip libpq-dev python3-dev libffi-dev libssl-dev && sudo apt-get -y clean
    echo "pip upgrade"
    ...
    ls /vagrant/$REL_DIR
    python -m pip install --user /vagrant/$REL_DIR/confluent_kafka-1.7.0-cp38-cp38-manylinux_2_17_x86_64.manylinux2014_x86_64.whl
}
