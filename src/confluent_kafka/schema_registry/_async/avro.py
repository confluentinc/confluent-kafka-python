...
class AsyncAvroSerializerBuilder(SerializerBuilder):
    """
    ...
    See :py:class:`AsyncAvroSerializer` for what the individual values mean.
    """
    ...
    def set_schema(self, schema_str: Union[str, Schema]) -> 'AsyncAvroSerializerBuilder':
        """The writer schema, as an Avro schema string or a :py:class:`Schema`."""
        self._schema_str = schema_str
        return self

    def set_to_dict(self, to_dict: Callable[[object, SerializationContext], dict]) -> 'AsyncAvroSerializerBuilder':
        """Callable converting the object being serialized to a dict."""
        self._to_dict = to_dict
        return self

    def set_serializer_config(self, serializer_conf: dict) -> 'AsyncAvroSerializerBuilder':
        """Serializer configuration, e.g. ``{'auto.register.schemas': False}``."""
        self._serializer_conf = serializer_conf
        return self

    def set_rule_config(self, rule_conf: dict) -> 'AsyncAvroSerializerBuilder':
        """Configuration passed to the rule executors and actions."""
        self._rule_conf = rule_conf
        return self

    def set_rule_registry(self, rule_registry: RuleRegistry) -> 'AsyncAvroSerializerBuilder':
    ...
    ) -> Coroutine[Any, Any, Tuple['AsyncAvroSerializer', Dict[str, Any]]]:
        """
...
class AsyncAvroDeserializerBuilder(DeserializerBuilder):
    ...
    See :py:class:`AsyncAvroDeserializer` for what the individual values mean.
    """
    ...
    def set_schema(self, schema_str: Union[str, Schema]) -> 'AsyncAvroDeserializerBuilder':
        """The reader schema, as an Avro schema string or a :py:class:`Schema`."""
        self._schema_str = schema_str
        return self

    def set_from_dict(
        self, from_dict: Callable[[dict, SerializationContext], object]
    ) -> 'AsyncAvroDeserializerBuilder':
        """Callable converting the deserialized dict to the object handed to the application."""
        self._from_dict = from_dict
        return self

    def set_return_record_name(self, return_record_name: bool) -> 'AsyncAvroDeserializerBuilder':
        """Whether to return a (record name, record) tuple rather than the record alone."""
        self._return_record_name = return_record_name
        return self

    def set_deserializer_config(self, deserializer_conf: dict) -> 'AsyncAvroDeserializerBuilder':
        """Deserializer configuration, e.g. ``{'use.latest.version': True}``."""
        self._deserializer_conf = deserializer_conf
        return self

    def set_rule_config(self, rule_conf: dict) -> 'AsyncAvroDeserializerBuilder':
        """Configuration passed to the rule executors and actions."""
        self._rule_conf = rule_conf
        return self

    def set_rule_registry(self, rule_registry: RuleRegistry) -> 'AsyncAvroDeserializerBuilder':
        """Rule registry to use instead of the global one."""
        self._rule_registry = rule_registry
        return self
    ...
    def build(  # type: ignore[override]
        self, conf: Dict[str, Any], is_key: bool
    ) -> Coroutine[Any, Any, Tuple['AsyncAvroDeserializer', Dict[str, Any]]]:
        """
