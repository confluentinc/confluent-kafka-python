...
class _AbstractAsyncOAuthClient(_BearerFieldProvider):
...
class _AsyncOAuthClient(_AbstractAsyncOAuthClient):
...
class _AsyncOAuthAzureIMDSClient(_AbstractAsyncOAuthClient):
