...
class JSONSerializer(BaseSerializer):
    ...
    def __init_impl(
        ...
        schema_dict, ref_registry = self._get_parsed_schema(self._schema)  # type: ignore[arg-type]
...
class JSONDeserializer(BaseDeserializer):
    ...
    def __init_impl(
        ...
        if schema:
            self._reader_schema, self._ref_registry = self._get_parsed_schema(self._schema)  # type: ignore[arg-type]
        else:
