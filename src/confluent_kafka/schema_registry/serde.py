...
class RuleContext(object):
    __slots__ = ['ser_ctx', 'source', 'target', 'subject', 'rule_mode', 'rule',
                 'index', 'rules', 'field_transformer']

    def __init__(self, ser_ctx, source, target, subject, rule_mode, rule,
        index, rules, field_transformer):
...
class FieldContext(object):
    ...
    def __init__(self, containing_message, full_name, name, type: FieldType, tags):
...
class BaseSerde(object):
    ...
    def _execute_rules(self, ser_ctx: SerializationContext, subject: str,
        ...
        for index in range(len(rules)):
            ...
            ctx = RuleContext(ser_ctx, source, target, subject, rule_mode, rule, index, rules, self._field_transform)
