...
static void AdminTypes_AddObjectsConsumerGroupStates (PyObject *m) {
        ...
        PyModule_AddIntConstant(m, "CGRP_STATE_UNKNOWN", RD_KAFKA_CGRP_STATE_UNKNOWN);
        PyModule_AddIntConstant(m, "CGRP_STATE_PREPARING_REBALANCE", RD_KAFKA_CGRP_STATE_PREPARING_REBALANCE);
        PyModule_AddIntConstant(m, "CGRP_STATE_COMPLETING_REBALANCE", RD_KAFKA_CGRP_STATE_COMPLETING_REBALANCE);
        PyModule_AddIntConstant(m, "CGRP_STATE_STABLE", RD_KAFKA_CGRP_STATE_STABLE);
        PyModule_AddIntConstant(m, "CGRP_STATE_DEAD", RD_KAFKA_CGRP_STATE_DEAD);
        PyModule_AddIntConstant(m, "CGRP_STATE_EMPTY", RD_KAFKA_CGRP_STATE_EMPTY);
}
