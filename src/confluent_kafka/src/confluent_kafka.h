 ...
 */
#define CFL_VERSION_STR "2.13.0rc1"
...
#define MIN_VER_ERRSTR                                                         \
        "confluent-kafka-python requires librdkafka v2.12.1 or later. "        \
...
#ifdef __APPLE__
#error                                                                         \
    "confluent-kafka-python requires librdkafka v2.12.1 or later. Install the latest version of librdkafka from Homebrew by running `brew install librdkafka` or `brew upgrade librdkafka`"
#else
#error                                                                         \
    "confluent-kafka-python requires librdkafka v2.12.1 or later. Install the latest version of librdkafka from the Confluent repositories, see http://docs.confluent.io/current/installation.html"
#endif
#endif
