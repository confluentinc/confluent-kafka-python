...
class AIOProducer:
    def __init__(self, producer_conf, max_workers=1,
        ...
        self.producer = confluent_kafka.Producer(producer_conf)
        self._running = False
        if auto_poll:
            self._running = True
    ...
    async def poll(self, *args, **kwargs):
        await self._call(self.producer.poll, *args, **kwargs)
    ...
    async def produce(self, *args, **kwargs):
        ...
        await self._call(self.producer.produce, *args, **kwargs)
        return await result

    async def init_transactions(self, *args, **kwargs):
        return await self._call(self.producer.init_transactions,
                                *args, **kwargs)

    async def begin_transaction(self, *args, **kwargs):
        return await self._call(self.producer.begin_transaction,
                                *args, **kwargs)

    async def send_offsets_to_transaction(self, *args, **kwargs):
        return await self._call(self.producer.send_offsets_to_transaction,
                                *args, **kwargs)

    async def commit_transaction(self, *args, **kwargs):
        return await self._call(self.producer.commit_transaction,
                                *args, **kwargs)

    async def abort_transaction(self, *args, **kwargs):
        return await self._call(self.producer.abort_transaction,
                                *args, **kwargs)

    async def flush(self, *args, **kwargs):
        return await self._call(self.producer.flush, *args, **kwargs)

    async def purge(self, *args, **kwargs):
        return await self._call(self.producer.purge, *args, **kwargs)

    async def set_sasl_credentials(self, *args, **kwargs):
        return await self._call(self.producer.set_sasl_credentials,
                                *args, **kwargs)
